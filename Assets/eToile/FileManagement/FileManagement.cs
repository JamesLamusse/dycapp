    ...
    public static byte[] StringToByteArray(string content)
    {
        ...
        switch (stringConversion)
        {
            ...
            case FM_StringMode.BigEndianUnicode:
                ...
                break;
            case FM_StringMode.Default:
                result = System.Text.Encoding.Default.GetBytes(content.ToArray());
                break;
            case FM_StringMode.Unicode:
    ...
    ********************************/
    ...
    public static void InstallLocalApk(string file, bool fullPath = false)
    {
        ...
        if (Application.platform == RuntimePlatform.Android)
        {
            ...
            {
                Debug.Log("[FileManagement.InstallLocalApk] The requested APK file wasn't found.");
            }
        }
        else
        {
            Debug.Log("[FileManagement.InstallLocalApk] Please export to some Android device.");
        }
    }
#else
    public static void InstallLocalApk(string file, bool fullPath = false)
    {
        Debug.LogError("[FileManagement.InstallLocalApk] Not supported in this platform.");
    }
#endif
}
